...
This document provides guidelines for internationalization of the ebou Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ebou_en.ts` remains unchanged.
