...
* ebou.conf: contains configuration settings for eboud or ebou-qt
* eboud.pid: stores the process id of eboud while running
...
* debug.log: contains debug information and general logging generated by eboud or ebou-qt
