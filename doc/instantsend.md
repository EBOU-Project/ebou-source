...
This mechanism has been integrated into Bitcore-Node-ebou which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eboupay/insight-api-ebou#web-socket-api](https://github.com/eboupay/insight-api-ebou#web-socket-api)
* API: [https://github.com/eboupay/insight-api-ebou#instantsend-transactions](https://github.com/eboupay/insight-api-ebou#instantsend-transactions)
