...
"""Verify that starting eboud with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start eboud with -h for help text")
        ...
        self.log.info("Start eboud with -version for version information")
