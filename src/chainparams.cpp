 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1639517782, nBits=1e0ffff0, nNonce=371454, vtx=1)
...
{
    const char* pszTimestamp = "Empowering professionals";
    const CScript genesisOutputScript = CScript() << ParseHex("041d35565477643c2611074ab31e837a710c75adbb77873c9ed54c08882577756ad192505be3278e1ebefb90f0280b9ae2d1378182b56a245db524654837b1ba9b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000ff17d4a7e763bc4acc255937df694347fd35c3af5652531aa4e80ad729b"); 
        ...
        genesis = CreateGenesisBlock(1639517782, 371454, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ff17d4a7e763bc4acc255937df694347fd35c3af5652531aa4e80ad729b"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a33d4e1d19e93609e822ef78364561c03581f13fdc5c1466a88d7c1441c6bb4"));
        ...
        vSeeds.emplace_back("node1.ebou.io");
        vSeeds.emplace_back("node2.ebou.io");
        ...
        // ebou BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // ebou BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // ebou BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"EYm916gtgDWJaVVEhAFiN2qKobZwWrHzGf"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000ff17d4a7e763bc4acc255937df694347fd35c3af5652531aa4e80ad729b")},
            }
        };

        chainTxData = ChainTxData{
            1639517782, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000005944f888a4588c4560a6e497763f00472f488e80254f81f621ac35f8f37"); 
        ...
        genesis = CreateGenesisBlock(1639517787UL, 356129UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000005944f888a4588c4560a6e497763f00472f488e80254f81f621ac35f8f37"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a33d4e1d19e93609e822ef78364561c03581f13fdc5c1466a88d7c1441c6bb4"));
        ...
        // Testnet ebou BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet ebou BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet ebou BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TUWANqtnxTr4aYgQwPLevw141EqTE3WDpa"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x000005944f888a4588c4560a6e497763f00472f488e80254f81f621ac35f8f37")},
            }
        };

        chainTxData = ChainTxData{
            1639517787, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1639517792, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x6d708d31d993b0468e479a98a311f2e50e2b73dfef6d8525373cdd6d88b94e41"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a33d4e1d19e93609e822ef78364561c03581f13fdc5c1466a88d7c1441c6bb4"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x6d708d31d993b0468e479a98a311f2e50e2b73dfef6d8525373cdd6d88b94e41")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 7UZbCAVfJGa38avLzd6sZUwsDBkzBohZtG6A45xN1rG46TrkkEL
        vSporkAddresses = {"TNhKuE4h7iGEc7GBFjDRmP4rk6qbaapwXb"};
        nMinSporkKeys = 1;
        ...
        // Regtest ebou addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest ebou script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest ebou BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest ebou BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest ebou BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
