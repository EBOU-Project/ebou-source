...
/** Utility functions used by the ebou Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ebou:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load ebou specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ebou specific theme is activated (light/dark).*/
