...
//! Interface for the src/evo part of a ebou node (eboud process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a ebou node (eboud process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a ebou node (eboud process).
...
//! Top-level interface for a ebou node (eboud process).
class Node
{
public:
    virtual ~Node() {}
