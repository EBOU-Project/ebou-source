Contributing to ebou Core
============================

The ebou Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/eboupay/ebou/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the ebou Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ebou
Network Protocol consensus changes.

Whether a pull request is merged into ebou Core rests with the project merge
...
Patches that change ebou consensus rules are considerably more involved than
...
Where a patch set proposes to change the ebou consensus, it must have been
...
The review process is normally fairly responsive on the ebou Core repository, however
...
The project leader is the release manager for each ebou Core release.
