...
Arguments:
    <base_directory> - The base directory of a ebou Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The ebou Core developers'
...
Arguments:
    <base_directory> - The base directory of ebou Core source code repository.
"""
...
Arguments:
    <file> - A source file in the ebou Core repository.
"""
